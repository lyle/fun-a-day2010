...
public class Jan29 extends PApplet {
...
float userTimeOut = 0.15f*60*60; //(?? seconds)
...
public void checkHit(float x,float y,int circleSize){
  for ( Body bdy = physics.getWorld().getBodyList(); bdy != null; bdy = bdy.getNext()) 
  { 
...
class Style { 
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "Jan29" });
  }
}
