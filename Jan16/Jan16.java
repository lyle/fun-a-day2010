...
public class Jan16 extends PApplet {
...
public void draw() {
  ...
  if (mousePressed) {
    ...
    randomBod.setUserData(new Style(color(PApplet.parseInt(random(200,255)),PApplet.parseInt(random(100,200)),200)));
...
class Style { 
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "Jan16" });
  }
}
