...
public class Jan18 extends PApplet {
...
public void draw() {
  ...
  if (mousePressed) {
    ...
    randomBod.setUserData(new Style(color(PApplet.parseInt(random(100,255)),0,PApplet.parseInt(random(200,255)))));
  }
...
class Style { 
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "Jan18" });
  }
}
