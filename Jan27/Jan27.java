...
public class Jan27 extends PApplet {
...
class Style { 
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "Jan27" });
  }
}
